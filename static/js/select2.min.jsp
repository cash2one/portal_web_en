    ...
    var b = function() {
        ...
        function(a, b, c) {
            ...
            d.prototype.bind = function(a) {
                ...
                $('body').delegate(this.$selection,"mousedown",
                function(a) {
                    1 === a.which && b.trigger("toggle", {
                        originalEvent: a
                    })
                }),
                $('body').delegate(this.$selection,"focus",
                function() {}),
                $('body').delegate(this.$selection,"blur",
                function() {}),
                a.on("selection:update",
                function(a) {
                    b.update(a.data)
        ...
        function(a, b, c) {
            ...
            d.prototype.bind = function() {
                var b = this;
                d.__super__.bind.apply(this, arguments),
                $('body').delegate(this.$selection,"click",
                function(a) {
                    b.trigger("toggle", {
                        originalEvent: a
                    })
                }),
                $('body').delegate(this.$selection,"click", ".select2-selection__choice__remove",
                function(c) {
                    var d = a(this),
                    e = d.parent(),
                    f = e.data("data");
        ...
        function(a, b, c) {
            ...
            d.prototype.bind = function(a, b, d) {
                ...
                this.$selection.on("input", ".select2-search--inline",
                function() {
        ...
        b.define("jquery.select2", ["jquery", "require", "./select2/core", "./select2/defaults"],
        function(a, b, c, d) {
        ...
        b.define("jquery.mousewheel", ["jquery"],
        function(a) {
            return a
        }),
        {
